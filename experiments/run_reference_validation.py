"""
Reference solution cross-validation: Radau vs BDF vs DOP853
If max_diff < 0.01 mmHg → reference is trustworthy.
"""
...
print('Computing reference solutions with three solvers...')
...
# Radau tighter (to confirm convergence)
