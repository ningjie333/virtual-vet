...
- [heavy-test-triage.md](heavy-test-triage.md): classification of long-running tests into hard validation, engineering regression, observation-only, and rewrite candidates
...
- [literature-backed-testing-plan.md](literature-backed-testing-plan.md): map of which kernel tests should be anchored to external veterinary literature and how to tighten them safely
- [test-evidence-registry.md](test-evidence-registry.md): auditable registry of external evidence sources, target tests, encoding status, and known discrepancies
